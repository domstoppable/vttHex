...
```{r load-training-data}
    # Load training files from training/*.csv
...
```{r plot-phoneme-data}
    phoneDF_with_phoneExposures <- merge(phoneDF, phone_translate, by.x='stimulus', by.y='test_word', keep.x=TRUE)
