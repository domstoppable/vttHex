...
can't use between variable as random slope - only random intercept

by item random effect

ryan last year - crowding study in eye perception
	by item and by speaker
	item / speaker


Correct ~ Training*Condition + (Condition|Subject) + (1|Stim)

McGurk
Correct ~ Training*Condition + (Condition|Subject) + (1|stim/speaker)
